    ...
    d3.csv('https://raw.githubusercontent.com/cafornaca/ECS272-Winter2021/main/Homework2/datasets/Police_Department_Incidents_-_Previous_Year__2016_.csv')
      .then(csv => {
        ...
        * ********************************/
        ...
        var x = d3.scaleTime()
          .domain(d3.extent(Object.keys(dailyCrimes), function(d) { 
            // console.log( d)
            return d; }))
          .range([ 0, width ]);
        svg.append("g")
        ...
        // Add Y axis
        var y = d3.scaleLinear()
          .domain([0, d3.max(Object.keys(dailyCrimes), function(d) { 
            // console.log("y: ", dailyCrimes[d])
        ...
        svg.append("path")
          ...
          .attr("d", d3.line()
            .x(function(d) { 
              // console.log("date line: ", d)
              return x(dailyCrimes) })
            .y(function(d) { 
