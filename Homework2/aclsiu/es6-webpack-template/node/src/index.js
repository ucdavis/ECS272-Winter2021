...
/*** Default charts ***/
/** Drawing bar chart **/
drawBarChart(numArtistPopularity_All, "#bar");

/** Drawing line chart **/
drawScatterplot(dance_All, "#scatter");

/** Drawing streamgraph **/
drawStreamGraph(key_All, "#stream");
...
function changeBar(value) {
    if (value == 'All') {
      ...
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_0to10, "#bar");
    } else if (value == '10-20') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_10to20, "#bar");
    } else if (value == '20-30') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_20to30, "#bar");
    } else if (value == '30-40') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_30to40, "#bar");
    } else if (value == '40-50') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_40to50, "#bar");
    } else if (value == '50-60') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_50to60, "#bar");
    } else if (value == '60-70') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_60to70, "#bar");
    } else if (value == '70-80') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_70to80, "#bar");
    } else if (value == '80-90') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_80to90, "#bar");
    } else if (value == '90-100') {
      d3.select("#barchart").remove();
      drawBarChart(numArtistPopularity_90to100, "#bar");
    } 
}
