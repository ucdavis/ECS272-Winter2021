        ...
        <div id="container">
          ...
          <div style={{display: "flex", flexDirection:"row", alignItems: 'center', justifyContent: "center", width: "100vw"}}>
            ...
            <div style={{display: "flex", flexDirection:"column", alignItems: 'center', justifyContent: "center"}}>
              <h3 style={{fontSize: "1vw", padding: "0px", margin: "0px"}}>Scatter with Arbitrary Numerical Columns (Random 5% of Data)</h3>
            ...
            <div style={{display: "flex"}}>
              <div style={{display: "flex", flexDirection:"column", alignItems: 'center'}}>
                ...
                <div style={{display: "flex", flexDirection:"row", alignItems: 'center'}}>
                  ...
                  <p style={{fontSize: ".7vw"}} id="areasum">Summary of region: </p>
                </div>
                <div id="area"> </div>
              </div>
            </div>
